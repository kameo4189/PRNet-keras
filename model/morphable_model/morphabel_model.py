    ...
    def fit(self, x, X_ind, max_iter = 4, isShow = False):
        ...
        if isShow:
            ...
            for i in range(R.shape[0]):
                angles[i] = common_methods.matrix2angle(R[i])
        else:
            ...
            angles = common_methods.matrix2angle(R)
